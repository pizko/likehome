...
window._s3Lang['GOOGLE_KEY_ERROR'] = "Отсутствует ключ для Google карты в системных настройках. <br>Инструкция по установке: инструкция недоступна";
...
window._s3Lang['JS_CHANGE_EDITOR'] = "Рекомендуется сменить версию текстового редактора на CkEditor";
